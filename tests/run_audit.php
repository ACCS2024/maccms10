...
$groups = [
    'unit' => [
        ...
        ['framework_audit_csv.php'], ['framework_audit_request_injection.php'], ['framework_audit_request_method.php'], ['framework_audit_client_ip.php'], ['framework_audit_receive.php'], ['framework_audit_request_security.php'],
