...
$groups = [
    'unit' => [
        ...
        ['framework_audit_user_lists.php'], ['framework_audit_ulog_template.php'], ['security_audit_member_order_url.php'], ['security_audit_order_amount.php'], ['security_audit_order_price_template.php'],
    ...
    'financial' => [['security_audit_membership.php'], ['security_audit_points_overflow.php'], ['security_audit_card_credit.php'], ['security_audit_task_rewards.php'], ['security_audit_comment_submission.php'], ['security_audit_comment_provenance.php'], ['security_audit_ledger_retention.php'], ['security_audit_order_create.php']],
