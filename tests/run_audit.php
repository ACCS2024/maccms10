...
$groups = [
    'unit' => [
        ...
        ['framework_audit_cache_connection.php'], ['framework_audit_cache_clear.php'], ['framework_audit_cache_flush.php'], ['framework_audit_cli_failures.php'], ['framework_audit_collection_paging.php'],
