...
$groups = [
    ...
    'financial' => [['security_audit_membership.php'], ['security_audit_points_overflow.php'], ['security_audit_card_credit.php'], ['security_audit_task_rewards.php'], ['security_audit_comment_submission.php'], ['security_audit_ledger_retention.php'], ['security_audit_order_create.php']],
