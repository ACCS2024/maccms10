...
$groups = [
    ...
    'models' => [
        ...
        ['framework_audit_cash.php'], ['framework_audit_cash_reads.php'], ['framework_audit_cash_write.php'], ['framework_audit_cash_request.php'], ['framework_audit_admin_cash.php'], ['framework_audit_admin_session.php'], ['framework_audit_member_session.php'], ['framework_audit_member_cookie.php'], ['framework_audit_auth_jwt.php'], ['framework_audit_purchase_csrf.php'], ['framework_audit_video_purchase.php'], ['framework_audit_art_purchase.php'], ['framework_audit_manga_purchase.php'],
