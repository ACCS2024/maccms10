...
$groups = [
    'unit' => [
        ...
        ['framework_audit_admin_audit_payload.php'], ['framework_audit_cache_connection.php'], ['framework_audit_cache_clear.php'], ['framework_audit_cache_flush.php'], ['framework_audit_player_config_cache.php'], ['framework_audit_cli_failures.php'], ['framework_audit_collection_paging.php'], ['framework_audit_collect_cache.php'],
        ['framework_audit_csv.php'], ['framework_audit_csv_roundtrip.php'], ['framework_audit_import_row_numbers.php'], ['framework_audit_import_columns.php'], ['framework_audit_import_text.php'], ['framework_audit_import_upload.php'], ['framework_audit_csv_budget.php'], ['framework_audit_bulk_export.php'], ['framework_audit_xlsx_text.php'], ['framework_audit_xlsx_budget.php'], ['framework_audit_request_injection.php'], ['framework_audit_request_method.php'], ['framework_audit_client_ip.php'], ['framework_audit_receive.php'], ['framework_audit_request_security.php'],
        ...
        ['framework_audit_opencc.php'], ['framework_audit_opencc_extension.php'], ['framework_audit_local_process.php'], ['framework_audit_system_metrics.php'], ['framework_audit_system_metrics_disabled.php'], ['framework_audit_page_responses.php'], ['framework_audit_frontend_gates.php'], ['framework_audit_constructor_response.php'], ['framework_audit_constructor_response.php', 'unbound'], ['framework_audit_user_forms.php'], ['framework_audit_auto_registration_views.php'], ['framework_audit_purchase_views.php'], ['framework_audit_cash_view.php'], ['framework_audit_user_lists.php'], ['framework_audit_ulog_template.php'], ['security_audit_member_order_url.php'], ['security_audit_order_amount.php'], ['security_audit_order_price_template.php'],
    ...
    'models' => [
        ...
        ['framework_audit_api_access.php'], ['framework_audit_cash.php'], ['framework_audit_cash_reads.php'], ['framework_audit_cash_api_reads.php'], ['framework_audit_cash_write.php'], ['framework_audit_cash_request.php'], ['framework_audit_admin_cash.php'], ['framework_audit_admin_cache.php'], ['framework_audit_admin_session.php'], ['framework_audit_member_session.php'], ['framework_audit_member_cookie.php'], ['framework_audit_auth_jwt.php'], ['framework_audit_purchase_csrf.php'], ['framework_audit_video_purchase.php'], ['framework_audit_art_purchase.php'], ['framework_audit_manga_purchase.php'],
    ...
    'financial' => [['security_audit_task_retention.php'], ['security_audit_visit_retention.php'], ['security_audit_visit_rewards.php'], ['security_audit_visit_redirect.php'], ['security_audit_cash_refund.php'], ['framework_audit_cash_owner.php'], ['framework_audit_cash_request_owner.php'], ['framework_audit_cash_storage.php'], ['framework_audit_cash_archive.php'], ['security_audit_membership.php'], ['security_audit_points_overflow.php'], ['security_audit_referral_storage.php'], ['security_audit_content_purchase.php'], ['framework_audit_purchase_owner.php'], ['framework_audit_purchase_caller.php'], ['framework_audit_reward_membership_owner.php'], ['framework_audit_order_owner.php'], ['framework_audit_order_storage.php'], ['security_audit_card_credit.php'], ['framework_audit_card_owner.php'], ['framework_audit_card_ingress.php'], ['security_audit_task_rewards.php'], ['security_audit_task_eligibility.php'], ['security_audit_comment_submission.php'], ['framework_audit_gbook_normal.php'], ['security_audit_comment_provenance.php'], ['security_audit_ledger_retention.php'], ['security_audit_order_create.php']],
