#!/usr/bin/env python3
"""Run AI internal resource regressions against disposable MySQL over a Unix socket."""
import os
...
def main():
    ...
    images = sys.argv[1:] or ["maccms-audit-image83:20260910", "maccms-audit-image84:20260910"]
    for image in ["mysql:8.0", *images]:
        subprocess.run(["docker", "image", "inspect", image], check=True, stdout=subprocess.DEVNULL)
    token = secrets.token_hex(6)
    name = "maccms-audit-ai-search-" + token
    password = secrets.token_hex(24)
    database = "maccms_audit_ai_search_" + token
    with tempfile.TemporaryDirectory(prefix="maccms-ai-search-") as temporary:
        ...
        try:
            ...
            for image in images:
                subprocess.run([
                    ...
                    "/app/tests/framework_audit_ai_search.php",
