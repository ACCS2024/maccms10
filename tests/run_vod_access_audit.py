#!/usr/bin/env python3
"""Run video resource/password authorization regressions against disposable MySQL over a Unix socket."""
import os
...
def main():
    ...
    subprocess.run(["node", str(root / "tests/vod_resource_frontend.js")], check=True, timeout=15)
        ...
        try:
            ...
            for image in images:
                subprocess.run([
                    ...
                    "/app/tests/framework_audit_vod_access.php",
