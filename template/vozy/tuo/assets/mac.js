/**
 * MAC JavaScript Library
 * A collection of utility functions for website functionality
 */

// Core string prototype extensions
...
// MAC object - main functionality container
var MAC = {
    'Url': document.URL,
    ...
    'Home': function(o, u) {
        try {
            ...
            // Modern browsers don't support this method
            MAC.Pop.Msg(150, 40, '请手动设置首页', 1000);
        }
    },
    'Fav': function(u, s) {
        try { 
    ...
    'Shorten': {
        ...
        'Get': function(url, call) {
            ...
            if($('.mac_shorten').length>0){$('.mac_shorten').val(url).html(url);}if(call){call({code:1,data:{url_short:url}});}return;MAC.Ajax('about:blank', 'get', 'jsonp', '', function(r) {
                if (r.code == 1) {
                    if ($('.mac_shorten').length > 0) {
