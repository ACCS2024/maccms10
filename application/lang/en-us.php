...
https://www.baidu.com/123.jpg',
  ...
  'menu/configppvod' => 'PPVOD transcoder ingest',
  ...
  'model/user/reward_err' => 'Referral reward failed',
  'model/financial/outcome_unknown' => 'The financial operation could not be confirmed. Check the records before submitting again. Diagnostic reference: %s.',
  ...
  'index/buy_popedom2' => 'Sorry, failed to update user points information. Please refresh and try again!',
    'index/buy_popedom_outcome_unknown' => 'The payment outcome could not be confirmed. Check your purchase records before paying again. Diagnostic reference: %s.',
  ...
  'admin/system/config/anti_scrape_api_tip' => 'Sliding-window limits per visitor IP on api.php; keyword-style requests use the stricter search bucket; timming is exempt by default.',
  ...
  'admin/system/config/anti_scrape_index_tip' => 'Limits suggest/data/search_hot/search_history to reduce bulk scraping.',
...
Note: If both black and white lists are filled, both policies will take effect.',
  ...
  'admin/ai_cover/msg_no_backup' => 'No original poster backup to restore.',
    'admin/ai_cover/msg_upstream_fail'=>'Upstream image generation failed.',
    'admin/ai_cover/msg_incomplete_backup'=>'Historical cover has no complete thumbnail backup; confirm the original pair manually.',
    'admin/ai_cover/msg_outcome_unknown'=>'Cover transaction outcome is unknown. Inspect reference %s before retrying.',
  ...
  'admin/batch/io_row' => 'Line %s',
    ...
    'admin/batch/io_text' => 'CSV/TXT requires UTF-8 without control characters such as NULL. Save as UTF-8 CSV or use an XLSX file.',
  ...
  'admin/upload/test_write_err' => 'Write failed, please check temporary file directory permissions',
  ...
  'api/require_comment_content' => 'Comment content is required',
  'api/never' => 'Never',
  ...
  'admin/system/configapi/datafilter_tip_manga'=>'SQL query condition e.g. manga_status=1',
    ...
    'admin/meilisearch/version_check' => 'Check version',
    'admin/meilisearch/version_check_running' => 'Checking...',
    'admin/meilisearch/multisite_title' => 'Multi-site index isolation (single-site can ignore)',
    'admin/meilisearch/multisite_text' => 'Currently using the shared default index name maccms_contents. When multiple sites share one Meilisearch, each site must use a distinct index_uid; otherwise document primary keys (e.g. vod_1, which are global) overwrite each other, corrupting search relevance and hit counts and causing cross-site deletes. Suggested unique index name for this site: ',
    'admin/meilisearch/use_suggested_uid' => 'Use unique name',
    'admin/meilisearch/multisite_after_switch' => 'After renaming and saving, click "Initialize index" then "Full sync" to rebuild.',
    'admin/meilisearch/index_uid_hint' => 'When multiple maccms instances share one Meilisearch, each site must use a different index_uid to avoid collisions.',
    ...
    'admin/vod/douban_view' => 'View Douban page',
    'admin/resourcehub/local_catalog_tip' => 'This directory is maintained locally. Add a custom API address to get started. Sites are contacted only when you request a check or collection.',
    ...
    'admin/cash/active' => 'Active withdrawals',
    'admin/cash/archive' => 'Withdrawal archive',
    'admin/cash/archive_readonly' => 'Read-only history. Cancelled reservations were refunded; approved records were archived without another refund.',
    'admin/cash/cancelled' => 'Cancelled and refunded',
    'admin/cash/user_id' => 'User ID',
    'admin/cash/archive_keyword' => 'Original record keyword',
    'admin/cash/archive_time' => 'Archived at',
    'admin/cash/actor' => 'Operator',
    'admin/cash/actor_internal' => 'Internal process',
    'admin/cash/actor_user' => 'Member',
    'admin/cash/actor_admin' => 'Administrator',
    'admin/cash/archive_unavailable' => 'Withdrawal archive is unavailable or contains an invalid record. Check the archive migration and stored data.',
);
