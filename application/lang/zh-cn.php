...
https://www.baidu.com/123.jpg
    ...
    'admin/system/config/anti_scrape_api_tip'=>'对 api.php 按 IP 滑动窗口限次；含关键词类请求使用更严的「搜索限频」；定时任务 timming 默认豁免。',
    ...
    'admin/ai_cover/msg_upstream_fail'=>'上游图片生成失败',
    'admin/ai_cover/msg_incomplete_backup'=>'历史封面缺少完整缩略图备份，请人工确认原图和缩略图',
    'admin/ai_cover/msg_outcome_unknown'=>'封面事务结果不明，请核查编号 %s 后再操作',
    ...
    'admin/upload/test_write_err'=>'写入失败，请检查临时文件目录权限',
    ...
    'api/require_comment_name' => '评论昵称不能为空',
    'api/require_comment_content' => '评论内容不能为空',
    'api/never'=>'从未',
    ...
    'admin/meilisearch/version_check' => '检查版本',
    'admin/meilisearch/version_check_running' => '检查中...',
    'admin/meilisearch/multisite_title' => '多站点索引隔离（单站点可忽略）',
    'admin/meilisearch/multisite_text' => '当前用的是共享默认索引名 maccms_contents。多个站点共用同一个 Meilisearch 时，每个站必须用不同的 index_uid，否则文档主键(如 vod_1，全局通用)会互相覆盖，导致搜索相关性错乱、命中数虚高、删一个站连带删另一个站。建议改用本站唯一索引名：',
    'admin/meilisearch/use_suggested_uid' => '填入本站唯一名',
    'admin/meilisearch/multisite_after_switch' => '改名并保存后，请依次点「一键初始化索引」和「全量同步」重建新索引。',
    'admin/meilisearch/index_uid_hint' => '多个 maccms 共用同一 Meilisearch 时，每个站点必须用不同的 index_uid，否则会串库。',
    ...
    'admin/vod/douban_view' => '查看豆瓣资料',
    'admin/resourcehub/local_catalog_tip' => '资源站目录由本站管理员维护。点击“添加自定义资源站”添加 API 地址，检测和采集只在您操作时执行。',
    ...
    'admin/cash/active' => '当前提现',
    'admin/cash/archive' => '提现归档',
    'admin/cash/archive_readonly' => '归档仅供查询。取消的申请已退还冻结积分；已审核记录移入归档时不再退款。',
    'admin/cash/cancelled' => '已取消并退款',
    'admin/cash/user_id' => '用户编号',
    'admin/cash/archive_keyword' => '原始记录关键词',
    'admin/cash/archive_time' => '归档时间',
    'admin/cash/actor' => '操作者',
    'admin/cash/actor_internal' => '内部程序',
    'admin/cash/actor_user' => '会员',
    'admin/cash/actor_admin' => '管理员',
    'admin/cash/archive_unavailable' => '提现归档不可用或存在异常记录，请检查归档迁移及数据。',
];
